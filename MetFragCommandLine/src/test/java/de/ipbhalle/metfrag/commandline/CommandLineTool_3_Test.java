...
public class CommandLineTool_3_Test {

	private String finalParameterFilePath;
	
	@Before
	public void setUp() {
		java.io.File parameterFilePath = new java.io.File(ClassLoader.getSystemResource("parameter_file_example_3.txt").getFile());
		String peakListFilePath = ClassLoader.getSystemResource("peaklist_file_example_3.txt").getFile();
		/*
