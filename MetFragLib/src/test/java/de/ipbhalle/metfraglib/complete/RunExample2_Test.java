package de.ipbhalle.metfraglib.complete;
...
public class RunExample2_Test {
	...
	public void setUp() throws Exception {
		...
		String peakListAnnotationFilePath = ClassLoader.getSystemResource("peaklist_annotation_example_1.txt").getFile();
		...
		settings.set(VariableNames.SMARTS_PEAK_ANNOTATION_FILE_NAME, peakListAnnotationFilePath);
		settings.set(VariableNames.METFRAG_SCORE_TYPES_NAME, new String[] {"FragmenterScore", "AutomatedSubstructureAnnotationScore"});
		settings.set(VariableNames.METFRAG_SCORE_WEIGHTS_NAME, new Double[] {1.0, 1.0});
