...
public abstract class AbstractTopDownBitArrayFragment extends DefaultBitArrayFragment {
	...
	protected java.util.ArrayList<AbstractTopDownBitArrayFragment> children;
	/*
	...
	public void addChild(AbstractTopDownBitArrayFragment child) {
		if(this.children == null)
			this.children = new java.util.ArrayList<AbstractTopDownBitArrayFragment>();
	...
	public java.util.ArrayList<AbstractTopDownBitArrayFragment> getChildren() {
