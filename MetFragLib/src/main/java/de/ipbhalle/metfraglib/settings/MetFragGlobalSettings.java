...
public class MetFragGlobalSettings extends Settings {
	...
	public MetFragGlobalSettings() {
		...
		this.defaults.put(VariableNames.LOSS_FINGERPRINT_ANNOTATION_ALPHA_VALUE_NAME, Constants.DEFAULT_LOSS_FINGERPRINT_ANNOTATION_ALPHA_VALUE);
		this.defaults.put(VariableNames.LOSS_FINGERPRINT_ANNOTATION_BETA_VALUE_NAME, Constants.DEFAULT_LOSS_FINGERPRINT_ANNOTATION_BETA_VALUE);;
