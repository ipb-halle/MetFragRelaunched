 ...
 */
package de.ipbhalle.metfraglib.inchi;
...
public class InChIGenerator {
    ...
    private void generateInchiFromCDKAtomContainer(IAtomContainer atomContainer, boolean ignore) throws CDKException {
        ...
        while (atoms.hasNext()) {
            ...
            /*
             * add by cruttkie 2015-02-10
             */
            Short implicitD = 0;
            if(atom.getProperty(VariableNames.DEUTERIUM_COUNT_NAME) != null)
            	implicitD = (Short)atom.getProperty(VariableNames.DEUTERIUM_COUNT_NAME);
            ...
            */
            ...
            iatom.setImplicitH(iatom.getImplicitH() - implicitD);
            iatom.setImplicitDeuterium(implicitD);
