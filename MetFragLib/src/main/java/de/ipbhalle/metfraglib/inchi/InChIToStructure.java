...
protected JniInchiInputInchi input;
    ...
    protected void generateAtomContainerFromInchi(IChemObjectBuilder builder) throws CDKException {
        ...
        for (int i = 0; i < output.getNumAtoms(); i ++) {
            ...
            /**
             * add by cruttkie 08_01_15
             */
            cAt.setProperty(VariableNames.DEUTERIUM_COUNT_NAME, (short)iAt.getImplicitDeuterium());
    ...
    public JniInchiOutputStructure getInchiOutputStructure() {
    	return this.output;
    }
